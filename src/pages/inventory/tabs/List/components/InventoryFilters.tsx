 ...
 *
 * Provides input controls for searching products by name, barcode, or batch, selecting a category from a list, and filtering by expiry status. Includes a reset button to clear all filters.
 *
